        ...
        while true do
            ...
            if HUD then
                ...
                elseif HUDtype == 7 then
                    drawRct(0.015, 0.779, 0.1420, 0.015, 42, 167, 75, 100) --Deux grosse barre au dessus de la map
                    drawRct(0.015, 0.779, faim / 704, 0.015, 42, 167, 75, 190)
                    drawRct(0.015, 0.794, 0.1420, 0.015, 26, 170, 199, 100)
                    drawRct(0.015, 0.794, soif / 704, 0.015, 26, 170, 199, 190) 
                end
