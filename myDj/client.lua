...
if not Config.useESX then
    Citizen.CreateThread(function()
        ...
        exports["Ora"]:TriggerServerCallback('myDJ:receiveRunningSongs', function(DJPositions)
    ...
    while true do
        ...
        if isAtDJ then
            ...
            if IsControlJustReleased(0, 38) then
                ...
                exports["Ora"]:TriggerServerCallback('myDJ:requestPlaylistsAndSongs', function(playlists, songs)
...
function playTitleFromPlaylist(DJName, DJPos, DJRange, link, playlistId)
    exports["Ora"]:TriggerServerCallback('myDJ:requestPlaylistById', function(playlistSongs)
