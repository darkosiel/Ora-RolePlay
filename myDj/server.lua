exports["Ora"]:RegisterServerCallback('myDJ:requestPlaylistsAndSongs', function(source, cb)
...
exports["Ora"]:RegisterServerCallback('myDJ:requestPlaylistById', function(source, cb, playlistId)
...
exports["Ora"]:RegisterServerCallback('myDJ:requestPlaylists', function(source, cb)
...
exports["Ora"]:RegisterServerCallback('myDJ:requestPlaylistSongs', function(source, cb, playlistId)
...
exports["Ora"]:RegisterServerCallback('myDJ:receiveRunningSongs', function(source, cb)
