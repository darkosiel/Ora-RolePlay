        ...
        function(Data)
            if Data ~= nil then
                ...
                if Data.food ~= nil and Data.thirst ~= nil then
                    exports['Atlantiss_utils']:InitHungerThirst(Data.food, Data.thirst)
                end
...
RMenu.Add(
    ...
    RageUI.CreateSubMenu(RMenu:Get("personnal", "settings"), "Paramètres", "Mon organisation")
)
...
RMenu.Add(
    ...
    RageUI.CreateSubMenu(RMenu:Get("personnal", "settings_organisation"), "Paramètres", "Faction > Roles")
)

RMenu.Add(
    "personnal",
    "settings_organisation_informations",
    RageUI.CreateSubMenu(RMenu:Get("personnal", "settings_organisation"), "Paramètres", "Faction > Informations")
)

RMenu.Add(
    "personnal",
    "settings_organisation_member_edit",
    RageUI.CreateSubMenu(RMenu:Get("personnal", "settings_organisation"), "Paramètres", "Faction > Editer un membre")
)

RMenu.Add(
    "personnal",
    "settings_organisation_rank_edit",
    RageUI.CreateSubMenu(RMenu:Get("personnal", "settings_organisation"), "Paramètres", "Faction > Editer un grade")
)

RMenu.Add(
    "personnal",
    "settings_organisation_rank_add",
    RageUI.CreateSubMenu(RMenu:Get("personnal", "settings_organisation"), "Paramètres", "Faction > Créer un grade")
)
                                ...
                                function(_, _, Selected)
                                    if (Selected) then
                                        if (not Settings:CanOpenRadioMenu()) then
                                            return RageUI.Popup({message = "~r~Vous êtes trop loin de votre enceinte"})
                                        end
...
Citizen.CreateThread(
    function()
        ...
        local HUDs = {"Défaut", "Défaut violet", "Défaut vert", "Défaut rouge", "Sous la map", "Base rouge", "Base"}
        local HUDsIdx = 1
        ...
        while true do
                ...
                RageUI.DrawContent(
                    ...
                    function()
                        ...
                        RageUI.Button(
                            ...
                            "Permet de gérer votre ~o~Faction~s~",
                            {},
                            true,
                            function(_, _, Selected)
                            end,
                    ...
                    function()
                        ...
                        for key, value in ipairs(zones) do
                            ...
                            if (value.isFull == true) then
                                RageUI.Button(
                                    "Dealer à " .. value.name .. boostedMessage .. " ~r~(Trop de dealers)~s~",
                                    "Impossible de dealer à " .. value.name .. " il y a déjà trop de dealers sur place" .. boostedMessage,
                                    {},
                                    false,
                                    function(_, _, Selected)
                                        if (Selected) then
                                            ShowNotification("~r~Il y a dejà trop de dealers la bas~s~")
                                        end
                                    end
                                )
                            elseif (value.hasEnoughCops == false) then
                                RageUI.Button(
                                    "Dealer à " .. value.name .. boostedMessage .. " ~r~(Pas de clients)~s~",
                                    "Impossible de dealer à " .. value.name .. " il n'y a pas de clients" .. boostedMessage,
                                    {},
                                    false,
                                    function(_, _, Selected)
                                        if (Selected) then
                                ...
                                RageUI.Button(
                                    "~g~Dealer à " .. value.name .. "~s~" .. boostedMessage,
                                    "Dealer à " .. value.name .. boostedMessage,
                                    {},
                                    false,
                                    function(_, _, Selected)
                                        if (Selected) then
            ...
            if RageUI.Visible(RMenu:Get("personnal", "settings_organisation_member_edit")) then
                ...
                RageUI.DrawContent({header = true, glare = true},
                    function()
                        RageUI.CenterButton(
                            "~b~↓↓↓ ~s~"..  IllegalOrga.MENU.CURRENT_PLAYER.fullname .." ~b~↓↓↓",
                            nil,
                            {},
                            true,
                            function(_, _, _)
            ...
            if RageUI.Visible(RMenu:Get("personnal", "settings_organisation_rank_add")) then
                RageUI.DrawContent({header = true, glare = true}, function()
                    ...
                    RageUI.Button(
                        labelInputName,
                        "Définir le nom du nouveau grade",
                        {},
                        true,
                        function(_, _, Selected)
                            if Selected then
                    ...
                    RageUI.Checkbox(
                        "Peut voir les labos & dépots ?",
                        "Voir les labos & dépots d'armes sur la map",
                    ...
                    RageUI.Checkbox(
                        "Peut entrer dans les labos & dépots ?",
                        "Peut entrer dans les labos & dépots d'armes",
                    ...
                    RageUI.Checkbox(
                        "Peut Gérer les grades ?",
                        "Permet de gérer les grades",
                    ...
                    RageUI.Checkbox(
                        ...
                        "Permet de gérer les membres de la faction",
            ...
            if RageUI.Visible(RMenu:Get("personnal", "settings_organisation_rank_edit")) then
                ...
                RageUI.DrawContent({header = true, glare = true},
                    function()
                        RageUI.CenterButton(
                            "~b~↓↓↓ ~s~"..  IllegalOrga.MENU.CURRENT_RANK.name .." ~b~↓↓↓",
                            nil,
                            {},
                            true,
                            function(_, _, _)
                        ...
                        RageUI.Checkbox(
                            "Peut voir les labos & dépots ? (Actuel : " .. currentValue .. ")",
                            "Voir les labos & dépots d'armes sur la map",
                            (IllegalOrga.MENU.CURRENT_RANK.NEW_VALUES.can_see_lab == 1 or IllegalOrga.MENU.CURRENT_RANK.NEW_VALUES.can_see_lab == true) and true or false,
                            {},
                            function(Hovered, Ative, Selected, Checked)
                        ...
                        RageUI.Checkbox(
                            "Peut entrer dans les labos & dépots ? (Actuel : " .. currentValue .. ")",
                            "Peut entrer dans les labos & dépots d'armes",
                            (IllegalOrga.MENU.CURRENT_RANK.NEW_VALUES.can_enter_lab == 1 or IllegalOrga.MENU.CURRENT_RANK.NEW_VALUES.can_enter_lab == true) and true or false,
                            {},
                            function(Hovered, Ative, Selected, Checked)
                        ...
                        RageUI.Checkbox(
                            "Peut Gérer les grades ? (Actuel : " .. currentValue .. ")",
                            "Permet de gérer les grades",
                            (IllegalOrga.MENU.CURRENT_RANK.NEW_VALUES.can_manage_rank == 1 or IllegalOrga.MENU.CURRENT_RANK.NEW_VALUES.can_manage_rank == true) and true or false,
                            {},
                            function(Hovered, Ative, Selected, Checked)
                        ...
                        RageUI.Checkbox(
                            "Peut Gérer les membres ? (Actuel : " .. currentValue .. ")",
                            "Permet de gérer les membres de la faction",
                            (IllegalOrga.MENU.CURRENT_RANK.NEW_VALUES.can_manage_member == 1 or IllegalOrga.MENU.CURRENT_RANK.NEW_VALUES.can_manage_member == true) and true or false,
                            {},
                            function(Hovered, Ative, Selected, Checked)
                        ...
                        if (type(IllegalOrga) == "table") then
                            ...
                            if (IllegalOrga.GetId() ~= nil) then
                                ...
                                if IllegalOrga.GetMyRank().can_manage_rank == 1 then
                                    RageUI.Button(
                                        "Gérer les grades",
                                        "Gérer les grades de votre organisation",
                                        {
                                            RightLabel = "→"
                                        },
                                        true,
                                ...
                                if IllegalOrga.GetMyRank().can_delete_orga == 1 then
                                    ...
                                    RageUI.CenterButton(
                                        "~h~~r~↓↓↓ Supprimer l'organisation ↓↓↓~h~~s~",
