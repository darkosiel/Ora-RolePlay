local Blips = {
    ...
    {name = "LSFD", color = 1, sprite = 61, Pos = {x = 217.72, y = -1636.81, z = 29.39}},
    -- {name = "Mécano", color = 3, sprite = 402, Pos = {x = -351.73, y = -120.49, z = 38.43}},
    ...
    {name = "Coiffeur", color = 64, sprite = 71, Pos = {x = -816.22, y = -182.72, z = 37.57}},
    {name = "Coiffeur Nord", color = 64, sprite = 71, Pos = {x = -277.868, y = 6227.947, z = 31.60}},
    ...
    {name = "Agence immobilière", color = 64, sprite = 492, Pos = {x = -1537.28, y = -577.91, z = 24.71}},
