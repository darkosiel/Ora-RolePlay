...
LogWeaponNames = {
    ...
    [tostring(GetHashKey("WEAPON_CROWBAR"))] = "Barre a mine",
    ...
    [tostring(GetHashKey("WEAPON_RAMMED_BY_CAR"))] = "Ecrasé par voiture",
    ...
    [tostring(GetHashKey("WEAPON_RUN_OVER_BY_CAR"))] = "Ecrasé par une voiture",
