    ...
    TriggerServerCallback(
        ...
        function(result)
            ...
            if amount - cost >= 0 then
                ...
                ShowNotification("~r~Pas assez d'argent dans le compte du Benny's !")
                can = false
            end
        end,
        "bennys"
...
LSBENNYS.BUY = function(cost)
    TriggerServerEvent("banking:removeAmountFromAccount", "bennys", cost)
end
...
RMenu.Add(
    "jobs",
    "LSC_BENNYS_CAT",
    RageUI.CreateSubMenu(RMenu:Get("jobs", "LSC_BENNYS"), nil, "Modifications disponibles", 10, 100)
)
...
RMenu.Add(
    "jobs",
    "LSC_BENNYS_CAT_COLOR",
    RageUI.CreateSubMenu(RMenu:Get("jobs", "LSC_BENNYS_CAT"), nil, "Modifications disponibles", 10, 100)
)

RMenu.Add(
    "jobs",
    "LSC_BENNYS_CAT_WHEELS_2",
    RageUI.CreateSubMenu(RMenu:Get("jobs", "LSC_BENNYS_CAT"), nil, "Modifications disponibles", 10, 100)
)

RMenu.Add(
    "jobs",
    "LSC_BENNYS_CAT_WHEELS_1",
    RageUI.CreateSubMenu(RMenu:Get("jobs", "LSC_BENNYS_CAT"), nil, "Modifications disponibles", 10, 100)
)

RMenu.Add(
    "jobs",
    "LSC_BENNYS_CAT_WHEELS_3",
    RageUI.CreateSubMenu(RMenu:Get("jobs", "LSC_BENNYS_CAT"), nil, "Modifications disponibles", 10, 100)
)

RMenu.Add(
    "jobs",
    "LSC_BENNYS_CAT_COLOR_1",
    RageUI.CreateSubMenu(RMenu:Get("jobs", "LSC_BENNYS_CAT_COLOR"), nil, "Modifications disponibles", 10, 100)
)

RMenu:Get("jobs", "LSC_BENNYS_CAT").Closed = function()
    UpdateCarB()
end

RMenu:Get("jobs", "LSC_BENNYS_CAT_COLOR").Closed = function()
    UpdateCarB()
end

RMenu:Get("jobs", "LSC_BENNYS_CAT_COLOR_1").Closed = function()
    UpdateCarB()
end

RMenu:Get("jobs", "LSC_BENNYS").Closed = function()
...
function EnterZoneLSC_BENNYS()
    Hint:Set("Appuyez sur ~INPUT_CONTEXT~ pour ouvrir le Benny's Customs")
    KeySettings:Add("keyboard", "E", OpenLSC_BENNYS, "LSC_BENNYS")
    KeySettings:Add("controller", 46, OpenLSC_BENNYS, "LSC_BENNYS")
end

function ExitZoneLSC_BENNYS()
    Hint:RemoveAll()
    KeySettings:Clear("keyboard", "E", "LSC_BENNYS")
    KeySettings:Clear("controller", 46, "LSC_BENNYS")
    RageUI.Visible(RMenu:Get("jobs", "LSC_BENNYS"), false)
end
...
Citizen.CreateThread(
    function()
        while true do
            Wait(1)
            if RageUI.Visible(RMenu:Get("jobs", "LSC_BENNYS")) then
                RageUI.DrawContent(
            ...
            if RageUI.Visible(RMenu:Get("jobs", "LSC_BENNYS_CAT")) then
                    ...
                    function()
                        if currentData.title == "Peintures" then
                            for k, v in pairs(currentData["data"]) do
                                RageUI.Button(
                                    ...
                                    RMenu:Get("jobs", "LSC_BENNYS_CAT_COLOR")
                                )
                            end
                        elseif currentData.title == "Jantes" then
                            if IsThisModelABike(currentvehicle) then
                                for k, v in pairs(currentData.data["Motos"]) do
                                    RageUI.Button(
                                        ...
                                        RMenu:Get("jobs", "LSC_BENNYS_CAT_WHEELS_2")
                                    )
                                end
                            else
                                for k, v in pairs(currentData.data["Type de jantes"]) do
                                    RageUI.Button(
                                        ...
                                        RMenu:Get("jobs", "LSC_BENNYS_CAT_WHEELS_1")
                                    )
                                end
                            end
                            ...
                            RageUI.Button(
                                ...
                                RMenu:Get("jobs", "LSC_BENNYS_CAT_WHEELS_3")
                            )
                            ...
                            for k, v in ipairs(currentData.data) do
                                ...
                                RageUI.Button(
                                    ...
                                    function(_, A, Selected)
                                        ...
                                        if Selected then
                                            if LSBENNYS.CanBuy(math.floor((v.cost / 100) * vehiclePrice)) then
                                                Vehicledata["Xenon"] = tostring(v.bool)
                                                LSBENNYS.BUY(math.floor((v.cost / 100) * vehiclePrice))
                                            else
                                            end
                                        end
                                    end
                        ...
                        elseif currentData.title == "Néons" then
                            ...
                            RageUI.Button("Couleur personnalisé", nil, {RightLabel = math.floor(((3.0*prc) / 100) * vehiclePrice) .. "$"}, true, function(_, A, Selected)
                                if Selected then
                                    ...
                                    if LSBENNYS.CanBuy(math.floor(((4.0*prc) / 100) * vehiclePrice)) then
                                        Vehicledata["NeonColours"] = {R, G, B}
                                        LSBENNYS.BUY(math.floor(((4.0*prc) / 100) * vehiclePrice))
                                        if ngc then
                                            Vehicledata.n0 = "true"
                                        end
                                        if ndt then
                            ...
                            for k,v in ipairs(currentData.data) do
                                ...
                                RageUI.Button(v.name, nil, t, true, function(_, A, Selected)
                                    ...
                                    if Selected then
                                        if LSBENNYS.CanBuy(math.floor(((v.cost*prc) / 100) * vehiclePrice)) then
                                            Vehicledata["NeonColours"] = v.colour
                                            LSBENNYS.BUY(math.floor(((v.cost*prc) / 100) * vehiclePrice))
                                            if ngc then
                                                Vehicledata.n0 = "true"
                                            end
                                            if ndt then
                                    ...
                                    function(_, A, Selected)
                                        ...
                                        if Selected then
                                            if LSBENNYS.CanBuy(math.floor((v.cost / 100) * vehiclePrice)) then
                                                ...
                                                LSBENNYS.BUY(math.floor(v.price))
                                            else
                                            end
                                        end
                                    end
            ...
            if RageUI.Visible(RMenu:Get("jobs", "LSC_BENNYS_CAT_WHEELS_1")) then
                local _v = currentvehicle
            ...
            if RageUI.Visible(RMenu:Get("jobs", "LSC_BENNYS_CAT_WHEELS_2")) then
                local _v = currentvehicle
            ...
            if RageUI.Visible(RMenu:Get("jobs", "LSC_BENNYS_CAT_WHEELS_3")) then
                local _v = currentvehicle
            ...
            if RageUI.Visible(RMenu:Get("jobs", "LSC_BENNYS_CAT_COLOR")) then
                local _v = currentvehicle
                    ...
                    function()
                        ...
                        for k, v in pairs(colorTab) do
                            RageUI.Button(
                                ...
                                RMenu:Get("jobs", "LSC_BENNYS_CAT_COLOR_1")
                            )
                        end
                    end,
                    function()
            ...
            if RageUI.Visible(RMenu:Get("jobs", "LSC_BENNYS_CAT_COLOR_1")) then
                local _v = currentvehicle
                        ...
                        for k, v in pairs(colorrrssTab) do
                            ...
                            RageUI.Button(
                                ...
                                function(_, A, Selected)
                                    ...
                                    if Selected and LSBENNYS.CanBuy((v.cost / 100) * vehiclePrice) then
                                        LSBENNYS.BUY((v.cost / 100) * vehiclePrice)
                                        if indexColor == "Couleurs primaires" then
...
function OpenLSC_BENNYS()
    if (
        RageUI.Visible(RMenu:Get('jobs', 'LSC_BENNYS')) == true or
        RageUI.Visible(RMenu:Get('jobs', 'LSC_BENNYS_CAT')) == true or
        RageUI.Visible(RMenu:Get('jobs', 'extrasB')) == true or
        RageUI.Visible(RMenu:Get('jobs', 'LSC_BENNYS_CAT_COLOR')) == true or
        RageUI.Visible(RMenu:Get('jobs', 'LSC_BENNYS_CAT_WHEELS_2')) == true or
        RageUI.Visible(RMenu:Get('jobs', 'LSC_BENNYS_CAT_WHEELS_1')) == true or
    ...
    if GetVehiclePedIsIn(LocalPlayer().Ped) ~= 0 then
        RageUI.Visible(RMenu:Get("jobs", "LSC_BENNYS"), true)
        currentvehicle = GetVehiclePedIsIn(LocalPlayer().Ped)
