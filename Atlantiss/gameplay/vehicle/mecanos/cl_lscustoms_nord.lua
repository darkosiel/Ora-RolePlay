...
LSNORD.BUY = function(cost)
    TriggerServerEvent("banking:removeAmountFromAccount", "mecano2", cost)
end
...
Citizen.CreateThread(
    function()
        while true do
                        ...
                        RageUI.Button(
                            ...
                            function(_, _, Selected)
                                if (Selected) then
                                    ...
                                    if (LSNORD.CanBuy(1500) and vehicle ~= 0) then
                                        LSNORD.BUY(1500)
            ...
            if RageUI.Visible(RMenu:Get("jobs", "extrasN")) then
                RageUI.DrawContent(
                    {header = true, glare = false},
                    function()
                        for i = 1, 30, 1 do
...
function OpenLSC_NORD()
    if (
        RageUI.Visible(RMenu:Get('jobs', 'LSC_NORD')) == true or
        RageUI.Visible(RMenu:Get('jobs', 'LSC_NORD_CAT')) == true or
        RageUI.Visible(RMenu:Get('jobs', 'extrasN')) == true or
        RageUI.Visible(RMenu:Get('jobs', 'LSC_NORD_CAT_COLOR')) == true or
        RageUI.Visible(RMenu:Get('jobs', 'LSC_NORD_CAT_WHEELS_2')) == true or
        RageUI.Visible(RMenu:Get('jobs', 'LSC_NORD_CAT_WHEELS_1')) == true or
