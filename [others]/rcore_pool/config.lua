Config = {
    ...
    Text = {
        ...
        AIM_LEFT = "Viser gauche",
        AIM_RIGHT = "Viser droite",
        AIM_SLOWER = "Viser doucement",

        POOL = 'Billard',
        POOL_GAME = 'Jeux',
        POOL_SUBMENU = 'Choisissez votre jeu',
        TYPE_8_BALL = '8-ball',
        TYPE_STRAIGHT = 'Straight pool',

        HINT_SETUP = 'Mettre en place le jeu',
        HINT_TAKE_CUE = 'Prendre une queue',
        HINT_RETURN_CUE = 'Remettre la queue',
        HINT_HINT_TAKE_CUE = 'Pour jouer vous devez avoir une queue',
        HINT_PLAY = 'Jouer',
        ...
        BALL_POCKETED = '%s est rentrée',
        BALL_IN_HAND_NOTIFY = 'Un joueur à la boule blanche en main',
        BALL_LABELS = {
            [-1] = 'Blanche',
            [1] = '~y~Pleine 1~s~',
            [2] = '~b~Pleine 2~s~',
