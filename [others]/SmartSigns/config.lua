...
config = {
    ...
    letterModels = {
        ["a"] = GetHashKey("prop_font_a"),
        ["b"] = GetHashKey("prop_font_b"),
        ["c"] = GetHashKey("prop_font_c"),
        ["d"] = GetHashKey("prop_font_d"),
        ["e"] = GetHashKey("prop_font_e"),
        ["f"] = GetHashKey("prop_font_f"),
        ["g"] = GetHashKey("prop_font_g"),
        ["h"] = GetHashKey("prop_font_h"),
        ["i"] = GetHashKey("prop_font_i"),
        ["j"] = GetHashKey("prop_font_j"),
        ["k"] = GetHashKey("prop_font_k"),
        ["l"] = GetHashKey("prop_font_l"),
        ["m"] = GetHashKey("prop_font_m"),
        ["n"] = GetHashKey("prop_font_n"),
        ["o"] = GetHashKey("prop_font_o"),
        ["p"] = GetHashKey("prop_font_p"),
        ["q"] = GetHashKey("prop_font_q"),
        ["r"] = GetHashKey("prop_font_r"),
        ["s"] = GetHashKey("prop_font_s"),
        ["t"] = GetHashKey("prop_font_t"),
        ["u"] = GetHashKey("prop_font_u"),
        ["v"] = GetHashKey("prop_font_v"),
        ["w"] = GetHashKey("prop_font_w"),
        ["x"] = GetHashKey("prop_font_x"),
        ["y"] = GetHashKey("prop_font_y"),
        ["z"] = GetHashKey("prop_font_z"),
        ["0"] = GetHashKey("prop_font_0"),
        ["1"] = GetHashKey("prop_font_1"),
        ["2"] = GetHashKey("prop_font_2"),
        ["3"] = GetHashKey("prop_font_3"),
        ["4"] = GetHashKey("prop_font_4"),
        ["5"] = GetHashKey("prop_font_5"),
        ["6"] = GetHashKey("prop_font_6"),
        ["7"] = GetHashKey("prop_font_7"),
        ["8"] = GetHashKey("prop_font_8"),
        ["9"] = GetHashKey("prop_font_9"),
    },
