            ...
            if IsControlJustReleased(0, Keys["C"]) then
                ...
                if #Editor.SelectedObjects > 0 then
                    ...
                    for i = 1, #lastSelectedObjects, 1 do
                        local obj =
                            Mapper.DuplicateObject(
                            lastSelectedObjects[i],
                            function(obj)
                                Editor.AddSelectedObject(obj)
                            end
                        )
...
Editor.HandleSelectedObjectsThisFrame = function()
    ...
    if IsControlPressed(0, Keys["Q"]) then
        for i = 1, #Editor.SelectedObjects, 1 do
            Editor.SelectedObjects[i]:rotate(
                Editor.SelectedObjects[i].rot.x,
                Editor.SelectedObjects[i].rot.y,
                Editor.SelectedObjects[i].rot.z + speedMultiplier
            )
        end
    end
    ...
    if IsControlPressed(0, Keys["LEFTCTRL"]) then
        if
            IsControlJustPressed(0, Keys["TOP"]) or IsControlJustPressed(0, Keys["DOWN"]) or
        ...
        if IsControlPressed(0, Keys["TOP"]) then
            for i = 1, #Editor.SelectedObjects, 1 do
                Editor.SelectedObjects[i]:rotate(
                    Editor.SelectedObjects[i].rot.x - speedMultiplier,
                    Editor.SelectedObjects[i].rot.y,
                    Editor.SelectedObjects[i].rot.z
                )
            end
        end
        ...
        if IsControlPressed(0, Keys["LEFT"]) then
            for i = 1, #Editor.SelectedObjects, 1 do
                Editor.SelectedObjects[i]:rotate(
                    Editor.SelectedObjects[i].rot.x,
                    Editor.SelectedObjects[i].rot.y - speedMultiplier,
                    Editor.SelectedObjects[i].rot.z
                )
            end
        end
        ...
        if IsControlPressed(0, Keys["LEFT"]) then
            ...
            for i = 1, #Editor.SelectedObjects, 1 do
                local coords =
                    vector3(
                    Editor.SelectedObjects[i].pos.x,
                    Editor.SelectedObjects[i].pos.y,
                    Editor.SelectedObjects[i].pos.z
                ) +
        ...
        if IsControlPressed(0, Keys["N+"]) then
            for i = 1, #Editor.SelectedObjects, 1 do
                Editor.SelectedObjects[i]:move(
                    Editor.SelectedObjects[i].pos.x,
                    Editor.SelectedObjects[i].pos.y,
                    Editor.SelectedObjects[i].pos.z + speedMultiplier
                )
            end
        end
