...
function SaveMap(name, objects)
	...
	local file = io.open('resources/[map]/es_mapper/data/maps/' .. name .. '.xml', 'w')
...
AddEventHandler('es_mapper:endSaveObjects', function(name)
	...
	TriggerClientEvent('es_mapper:showNotification', _source, 'Map [' .. name .. '] ~g~enregistré')
end)
...
AddEventHandler('es_mapper:loadObjects', function(name)
	...
	if dom == nil then
		TriggerClientEvent('es_mapper:showNotification', _source, 'Map [' .. name .. '] ~r~n\'existe pas')
	else
		...
		CreateThread(function()
			...
			TriggerClientEvent('es_mapper:showNotification', _source, 'Map [' .. name .. '] ~b~loaded')
