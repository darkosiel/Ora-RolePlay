Config = {
	...
	Text = {
		...
		REGISTER_LANE = '~INPUT_PICKUP~ Créer une partie~n~~INPUT_SPRINT~ + ~INPUT_PICKUP~ Créer une nouvelle équipe',
		JOIN_LANE = '~INPUT_PICKUP~ Rejoindre partie',
		PLAY = '~INPUT_PICKUP~ Jouer',
		OPEN = '~INPUT_PICKUP~ Ouvrir',
		TAKE_BALL = '~INPUT_PICKUP~ Prendre la boule',

		NOT_IN_GAME = 'Vous n\'êtes pas dans une partie.',
		NOT_ENOUGH_MONEY = 'Vous n\'avez pas les moyens de payer le wager.',
		INPUT_POSITION = 'Selectionner la ~y~position initiale de la boule~s~',
		INPUT_ROTATION = 'Selectionner ~y~l\'effet~s~ de la boule',
		INPUT_ANGLE = 'Selectionner ~y~angle de visée~s~',
		INPUT_POWER = 'Selectionner ~y~puissance~s~',
		
        TOTAL = "Total",
        MATCH_END = "La partie se termine dans {0} secondes",
		...
		WAGER = "Wager",
		WAGER_SET_TO = "Wager est mit à <b>${0}</b>",
