mumbleConfig = {
    voiceModes = {
        {1.8, "Chuchoter"}, -- Whisper speech distance in gta distance units
        {3, "Normal"}, -- Normal speech distance in gta distance units
        {15, "Crier"}, -- Shout speech distance in gta distance units
    },
