local Blips = {
   ...
   -- {name = "Harmony Repairs", color = 61, sprite = 488, size = 1.05, Pos = {x = 1178.06, y = 2646.36, z = 37.75}},
    ...
    {name = "Maze Bank Arena", color = 49, sprite = 78, size = 0.80, Pos = {x = -321.50, y = -1970.17, z = 69.65}},
    {name = "Kirby'sness", color = 64, sprite = 366, Pos = {x = -829.413, y = -1073.710, z = 10.328}},
    ...
    {name = "LTD little Seoul", color = 3, sprite = 59, Pos = {x = -708.30, y = -904.05, z = 19.21}},   
   ...
   -- {name = "8 Billards", color = 83, sprite = 509, Pos = {x = -1615.01, y = -986.46, z = 13.02}},
    --{name = "Tables Blackjack", color = 81, sprite = 628, Pos = {x = 923.48, y = 45.2, z = 235.63}},
    --{name = "Tribunal", color = 2, sprite = 79, Pos = {x = 243.34, y = -1073.30, z = 29.28}},
    ...
    {name = "Armurerie - Los Santos", color = 49, sprite = 313, Pos = {x = -925.6823, y = -2029.9206, z = 9.4787}},
   ...
   -- {name = "US MARSHALS", color = 0, sprite = 419, size = 0.60, Pos = {x = 414.89, y = -981.22, z = 29.44}},
    ...
    {name = "Cabinet Mordvinov", color = 25, sprite = 124, Pos = {x = -603.28, y = -347.99, z = 35.24}},
    {name = "Cabinet Willum", color = 25, sprite = 124, Pos = {x = -480.33, y = -692.36, z = 35.24}},
    {name = "Cabinet Jack Gab & associates", color = 25, sprite = 124, Pos = {x = -1040.31, y = -759.90, z = 35.24}},
