Jobs = {
            ...
            buttons = {
                ...
                },
                {
                    ...
                    onSelected = function()
                        ...
                        local text = exports['Snoupinput']:GetInput()
                        if text ~= false and text ~= "" then
                            TriggerServerEvent("Job:Annonce", "Los Santos Event", "Annonce", text, "CHAR_lsevent", 8, "Los Santos Event")
                        end
                    end
                }
            }
    ...
    coiffeur4 = {
        ...
        Storage = {
            {
                Pos = {x = -808.6365, y = -179.9821, z = 37.5688 - 0.98},
                Limit = 500,
                Name = "coffre_coiffeur4"
            }
        },
        garage = {
            Name = "Garage bobmulet",
            Pos = {x = -792.6481, y = -175.5866, z = 37.2836 - 0.98},
            Properties = {
                type = 3,
                Limit = 20,
                vehicles = {
                ...
                spawnpos = {x = -792.6481, y = -175.5866, z = 37.2836 - 0.98, h = 31.3634}
            },
            Blipdata = {
                Pos = {},
                Blipcolor = 7,
                Blipname = "Garage - Bob Mulet"
            }
        },
        Menu = {
            menu = {
            ...
            buttons = {
                ...
                },
                {
                    ...
                    onSelected = function()
                        ...
                        local text = exports['Snoupinput']:GetInput()
                        if text ~= false and text ~= "" then
                            TriggerServerEvent("Job:Annonce", "Bob Mulet", "Annonce", text, "CHAR_BARBER", 8, "Bob Mulet")
                        end
                    end
                }
            }
    ...
    ammunation = {
        ...
        garage = {
            ...
            Properties = {
                ...
                spawnpos = {x = -891.92, y = -2043.82, z = 8.99, h = 135.70}
            },
            Blipdata = {
                Pos = {},
                Blipcolor = 7,
            ...
            buttons = {
                ...
                },
                {
                    ...
                    onSelected = function()
                        ...
                        local text = exports['Snoupinput']:GetInput()
                        if text ~= false and text ~= "" then
                            TriggerServerEvent("Job:Annonce", "Empayeur Tattoo", "Annonce", text, "CHAR_TATTOO444", 8, "Tatoueur")
                        end
                    end
                }
            }
            ...
            buttons = {
                ...
                },
                {
                    ...
                    onSelected = function()
                        ...
                        local text = exports['Snoupinput']:GetInput()
                        if text ~= false and text ~= "" then
                            TriggerServerEvent("Job:Annonce", "LTD little Seoul", "Annonce", text, "CHAR_LTD", 8, "LTD little Seoul")
                        end
                    end
                }
            }
            ...
            buttons = {
                ...
                },
                {
                    ...
                    onSelected = function()
                        ...
                        local text = exports['Snoupinput']:GetInput()
                        if text ~= false and text ~= "" then
                            TriggerServerEvent("Job:Annonce", "Cabinet Willum", "Annonce", text, "CHAR_WILLUM", 8, "Cabinet Willum")
                        end
                    end
                }
            }
            ...
            buttons = {
                ...
                },
                {
                    ...
                    onSelected = function()
                        ...
                        local text = exports['Snoupinput']:GetInput()
                        if text ~= false and text ~= "" then
                            TriggerServerEvent("Job:Annonce", "Cabinet Mordvinov", "Annonce", text, "CHAR_MORDVINOV", 8, "Cabinet Mordvinov")
                        end
                    end
                }
            }
    ...
    mazegroup = {
        ...
        garage3 = {
            Name = "Garage Occasion",
            Pos = {x = -1384.1158, y = -481.6672, z = 31.5933},
            Properties = {
                type = 3,
                Limit = 20,
                vehicles = {},
                spawnpos = {x = -1384.1158, y = -481.6672, z = 31.5933, h = 23.8644}
            },
            Blipdata = {
                Pos = {x = -1384.1158, y = -481.6672, z = 31.5933},
                Blipcolor = 5,
                Blipname = "Garage Maze Occasion"
            }
        },
        Extrapos = {
            Banker = {
    ...
    usss = {
        ...
        garage3 = {
            ...
            Properties = {
                ...
                spawnpos = {x = -1311.5385, y = -551.7341, z = 43.9235, h = 216.9468}
            },
            Blipdata = {
                Pos = {},
                Blipcolor = 7,
            ...
            buttons = {
                ...
                },
                {
                    ...
                    onSelected = function()
                        ...
                        local text = exports['Snoupinput']:GetInput()
                        if text ~= false and text ~= "" then
                            TriggerServerEvent("Job:Annonce", "Departement de la justice", "Annonce", text, "CHAR_DOJ", 8, "Departement de la justice")
                        end
                    end
                }
            }
    ...
    lsms = {
        ...
        garage5 = {
            Name = "Garage SAMS Perso",
            Pos = {x = -1820.9343, y = -374.2449, z = 40.6693 - 0.98},
            Properties = {
                type = 3,
                Limit = 64,
                vehicles = {},
                spawnpos = {x = -1820.9343, y = -374.2449, z = 40.6693, h = 112.5330}
            },
            Blipdata = {
                Pos = {x = -1820.9343, y = -374.2449, z = 40.6693},
                Blipcolor = 7,
                Blipname = "SAMS - Garage Perso"
            }
        },
        Storage = {
            {
        ...
        work = {
            vestiaire = {
                type = "Vestiaire",
                workSize = 1.45,
                Pos = {x = -1813.41, y = -357.94, z = 49.46},
                vestiaire = {
                    type = "Vestiaire",
                    workSize = 1.45,
                    Pos = {x = -1813.41, y = -357.94, z = 49.46},
    ...
    mecano = {
        ...
        garage2 = {
            Name = "Garage Mécano Occasion",
            Pos = {x = -361.1195, y = -97.2043, z = 45.6664},
            Properties = {
                type = 3,
                Limit = 20,
                vehicles = {},
                spawnpos = {x = -361.1195, y = -97.2043, z = 45.6664, h = 342.0298}
            },
            Blipdata = {
                Pos = {x = -361.1195, y = -97.2043, z = 45.6664},
                Blipcolor = 5,
        ...
        Extrapos = {
            ...
            LSCustoms = {
                Pos = {
                    {x = -345.3406, y = -102.4909, z = 39.0285}, -- Zone cachée
                    {x = -353.3158, y = -99.3509, z = 39.0285},
                    {x = -336.3551, y = -105.2784, z = 39.0285},
                    {x = -333.1419, y = -133.0858, z = 39.0096}, -- Zone de vente 
                    {x = -313.4157, y =  -134.6332, z = 39.0096},
                    {x = -317.2148, y = -145.3679, z = 39.0096},
                    {x = -321.0939, y = -156.2644, z = 39.0096},
        ...
        Storage = {
            {
                Pos = {x =  -350.2949, y = -131.5896, z = 42.0367},
                Limit = 1000,
                Name = "coffre_mecano"
            },
            {
            ...
            buttons = {
                ...
                },
                {
                    ...
                    onSelected = function()
                        ...
                        local text = exports['Snoupinput']:GetInput()
                        if text ~= false and text ~= "" then
                            TriggerServerEvent("Job:Annonce", "Unicorn", "Annonce", text, "CHAR_UNICORN", 8, "Unicorn")
                        end
                    end
                },
                {
