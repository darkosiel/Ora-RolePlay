...
function Ambulance.GetOffStretcher()
    ...
    if veh ~= 0 and GetEntityModel(veh) == GetHashKey("samsbisonamb") or GetEntityModel(veh) == GetHashKey("samsspeedoamb") or GetEntityModel(veh) == GetHashKey("samsspeedoamb2") then
