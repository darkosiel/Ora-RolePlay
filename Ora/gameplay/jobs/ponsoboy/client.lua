...
-- end
-- local manPos = {
--     {-710.69, -162.37, 36.41, 342.62},
--     {-701.5023, -157.1996, 37.4152, 22.17339},
--     {-717.9795, -148.5724, 37.4152, 246.60409},
--     {}
-- }
...
--                                 saccolor = {}
--                                 saccolorPos = 1
--                                 for i = 0 , GetNumberOfPedTextureVariations(ped, 5, Index-1), 1 do
...
--     saccolor = {}
--     for i = 0 , GetNumberOfPedTextureVariations(ped, 5), 1 do
--         table.insert(saccolor, i)
--     end
...
local modelPositions = {
    {-710.69, -162.37, 36.41, 342.62},
    {-700.5023, -152.1996, 37.4152, 99.17339},
    {-717.9795, -148.5724, 37.4152, 246.60409},
}

local clear = { -706.05, -151.02, 36.41, 258.55, 3.0, 1}

CreateClotheSellerMenu("ponsonbys", "Ponsonbys", modelPositions, clear)