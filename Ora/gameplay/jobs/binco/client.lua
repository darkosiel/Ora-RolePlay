...
RMenu.Add('binco',"main", RageUI.CreateMenu("Binco", "Actions disponibles",10,100))
local pedPrev = {}
...
local manPos = {
    {-831.24, -1072.53, 10.34, 246.51},
    {-827.18, -1070.54, 10.33, 172.11},
    {-827.29, -1079.48, 11.34, 331.79}
}
...
RMenu:Get("binco","main").Closed = function()
...
Citizen.CreateThread(function()
    ...
    while true do
        ...
        if RageUI.Visible(RMenu:Get("binco","main")) then
