...
function LSCONCESS.CanBuy(cost)
    local can = nil
    TriggerServerCallback(
        ...
        function(result)
            ...
            if amount - cost >= 0 then
                ...
                ShowNotification("~r~Pas assez d'argent dans le compte du Concessionnaire !")
                can = false
            end
        end,
        "concess"
...
LSCONCESS.BUY = function(cost)
    TriggerServerEvent("banking:removeAmountFromAccount", "concess", cost)
end
...
RMenu.Add(
    "jobs",
    "LSC_CONCESS_CAT",
    RageUI.CreateSubMenu(RMenu:Get("jobs", "LSC_CONCESS"), nil, "Modifications disponibles", 10, 100)
)
...
RMenu.Add(
    "jobs",
    "LSC_CONCESS_CAT_COLOR",
    RageUI.CreateSubMenu(RMenu:Get("jobs", "LSC_CONCESS_CAT"), nil, "Modifications disponibles", 10, 100)
)

RMenu.Add(
    "jobs",
    "LSC_CONCESS_CAT_WHEELS_2",
    RageUI.CreateSubMenu(RMenu:Get("jobs", "LSC_CONCESS_CAT"), nil, "Modifications disponibles", 10, 100)
)

RMenu.Add(
    "jobs",
    "LSC_CONCESS_CAT_WHEELS_1",
    RageUI.CreateSubMenu(RMenu:Get("jobs", "LSC_CONCESS_CAT"), nil, "Modifications disponibles", 10, 100)
)

RMenu.Add(
    "jobs",
    "LSC_CONCESS_CAT_WHEELS_3",
    RageUI.CreateSubMenu(RMenu:Get("jobs", "LSC_CONCESS_CAT"), nil, "Modifications disponibles", 10, 100)
)

RMenu.Add(
    "jobs",
    "LSC_CONCESS_CAT_COLOR_1",
    RageUI.CreateSubMenu(RMenu:Get("jobs", "LSC_CONCESS_CAT_COLOR"), nil, "Modifications disponibles", 10, 100)
)
...
function EnterZoneLSC_CONCESS()
    Hint:Set("Appuyez sur ~INPUT_CONTEXT~ pour ouvrir le Menu Customs")
    KeySettings:Add("keyboard", "E", OpenLSC_CONCESS, "LSC_CONCESS")
    KeySettings:Add("controller", 46, OpenLSC_CONCESS, "LSC_CONCESS")
end

function ExitZoneLSC_CONCESS()
    Hint:RemoveAll()
    KeySettings:Clear("keyboard", "E", "LSC_CONCESS")
    KeySettings:Clear("controller", 46, "LSC_CONCESS")
    RageUI.Visible(RMenu:Get("jobs", "LSC_CONCESS"), false)
end
...
Citizen.CreateThread(
    function()
        while true do
            Wait(1)
            if RageUI.Visible(RMenu:Get("jobs", "LSC_CONCESS")) then
                RageUI.DrawContent(
                    ...
                    function()
                        for k, v in ipairs(customs) do
                            RageUI.Button(
                                ...
                                RMenu:Get("jobs", "LSC_CONCESS_CAT")
                            )
                        end
                        ...
                        RageUI.Button(
                            ...
                            function(_, _, Selected)
                                if (Selected) then
                                    ...
                                    if (LSCONCESS.CanBuy(1500) and vehicle ~= 0) then
                                        LSCONCESS.BUY(1500)
            ...
            if RageUI.Visible(RMenu:Get("jobs", "extrasB")) then
                RageUI.DrawContent(
                    {header = true, glare = false},
                    function()
                        for i = 1, 30, 1 do
            ...
            if RageUI.Visible(RMenu:Get("jobs", "LSC_CONCESS_CAT")) then
                    ...
                    function()
                        if currentData.title == "Peintures" then
                            for k, v in pairs(currentData["data"]) do
                                RageUI.Button(
                                    ...
                                    RMenu:Get("jobs", "LSC_CONCESS_CAT_COLOR")
                                )
                            end
                        elseif currentData.title == "Jantes" then
                            if IsThisModelABike(currentvehicle) then
                                for k, v in pairs(currentData.data["Motos"]) do
                                    RageUI.Button(
                                        ...
                                        RMenu:Get("jobs", "LSC_CONCESS_CAT_WHEELS_2")
                                    )
                                end
                            else
                                for k, v in pairs(currentData.data["Type de jantes"]) do
                                    RageUI.Button(
                                        ...
                                        RMenu:Get("jobs", "LSC_CONCESS_CAT_WHEELS_1")
                                    )
                                end
                            end
                            ...
                            RageUI.Button(
                                ...
                                RMenu:Get("jobs", "LSC_CONCESS_CAT_WHEELS_3")
                            )
                            ...
                            for k, v in ipairs(currentData.data) do
                                ...
                                RageUI.Button(
                                    ...
                                    function(_, A, Selected)
                                        ...
                                        if Selected then
                                            if LSCONCESS.CanBuy(math.floor((v.cost / 100) * vehiclePrice)) then
                                                Vehicledata["Xenon"] = tostring(v.bool)
                                                LSCONCESS.BUY(math.floor((v.cost / 100) * vehiclePrice))
                                            else
                                            end
                                        end
                                    end
                        ...
                        elseif currentData.title == "Néons" then
                            ...
                            RageUI.Button("Couleur personnalisé", nil, {RightLabel = math.floor(((3.0*prc) / 100) * vehiclePrice) .. "$"}, true, function(_, A, Selected)
                                if Selected then
                                    ...
                                    if LSCONCESS.CanBuy(math.floor(((4.0*prc) / 100) * vehiclePrice)) then
                                        Vehicledata["NeonColours"] = {R, G, B}
                                        LSCONCESS.BUY(math.floor(((4.0*prc) / 100) * vehiclePrice))
                                        if ngc then
                                            Vehicledata.n0 = "true"
                                        end
                                        if ndt then
                            ...
                            for k,v in ipairs(currentData.data) do
                                ...
                                RageUI.Button(v.name, nil, t, true, function(_, A, Selected)
                                    ...
                                    if Selected then
                                        if LSCONCESS.CanBuy(math.floor(((v.cost*prc) / 100) * vehiclePrice)) then
                                            Vehicledata["NeonColours"] = v.colour
                                            LSCONCESS.BUY(math.floor(((v.cost*prc) / 100) * vehiclePrice))
                                            if ngc then
                                                Vehicledata.n0 = "true"
                                            end
                                            if ndt then
                                    ...
                                    function(_, A, Selected)
                                        ...
                                        if Selected then
                                            if LSCONCESS.CanBuy(math.floor((v.cost / 100) * vehiclePrice)) then
                                                ...
                                                LSCONCESS.BUY(math.floor(v.price))
                                            else
                                            end
                                        end
                                    end
            ...
            if RageUI.Visible(RMenu:Get("jobs", "LSC_CONCESS_CAT_WHEELS_1")) then
                local _v = currentvehicle
            ...
            if RageUI.Visible(RMenu:Get("jobs", "LSC_CONCESS_CAT_WHEELS_2")) then
                local _v = currentvehicle
            ...
            if RageUI.Visible(RMenu:Get("jobs", "LSC_CONCESS_CAT_WHEELS_3")) then
                local _v = currentvehicle
            ...
            if RageUI.Visible(RMenu:Get("jobs", "LSC_CONCESS_CAT_COLOR")) then
                local _v = currentvehicle
                    ...
                    function()
                        ...
                        for k, v in pairs(colorTab) do
                            RageUI.Button(
                                ...
                                RMenu:Get("jobs", "LSC_CONCESS_CAT_COLOR_1")
                            )
                        end
                    end,
                    function()
            ...
            if RageUI.Visible(RMenu:Get("jobs", "LSC_CONCESS_CAT_COLOR_1")) then
                local _v = currentvehicle
                        ...
                        for k, v in pairs(colorrrssTab) do
                            ...
                            RageUI.Button(
                                ...
                                function(_, A, Selected)
                                    ...
                                    if Selected and LSCONCESS.CanBuy((v.cost / 100) * vehiclePrice) then
                                        LSCONCESS.BUY((v.cost / 100) * vehiclePrice)
                                        if indexColor == "Couleurs primaires" then
...
function OpenLSC_CONCESS()
    if (
        RageUI.Visible(RMenu:Get('jobs', 'LSC_CONCESS')) == true or
        RageUI.Visible(RMenu:Get('jobs', 'LSC_CONCESS_CAT')) == true or
        RageUI.Visible(RMenu:Get('jobs', 'extrasB')) == true or
        RageUI.Visible(RMenu:Get('jobs', 'LSC_CONCESS_CAT_COLOR')) == true or
        RageUI.Visible(RMenu:Get('jobs', 'LSC_CONCESS_CAT_WHEELS_2')) == true or
        RageUI.Visible(RMenu:Get('jobs', 'LSC_CONCESS_CAT_WHEELS_1')) == true or
        RageUI.Visible(RMenu:Get('jobs', 'LSC_CONCESS_CAT_WHEELS_3')) == true or
        RageUI.Visible(RMenu:Get('jobs', 'LSC_CONCESS_CAT_COLOR_1')) == true
    ) then
    ...
    if GetVehiclePedIsIn(LocalPlayer().Ped) ~= 0 then
        RageUI.Visible(RMenu:Get("jobs", "LSC_CONCESS"), true)
        currentvehicle = GetVehiclePedIsIn(LocalPlayer().Ped)
