    ...
    category = {
        {
            ...
            component = 11,
            type = 0,
            staticM = j.decode(Config.Haut),
            staticF = j.decode(Config.HautF),
        ...
        },
        {
            ...
            component = 4,
            type = 0,
            staticM = j.decode(Config.Pant),
            staticF = j.decode(Config.PantF),
        ...
        },
        {
            ...
            component = 6,
            type = 0,
            staticM = j.decode(Config.Shoes),
            staticF = j.decode(Config.ShoesF),
        ...
        },
        {
            ...
            component = 7,
            type = 0,
            staticM = j.decode(Config.Accessories),
            staticF = j.decode(Config.AccessoriesF),
        ...
        },
        {
            ...
            component = 0,
            type = 1,
            staticM = j.decode(Config.Hats),
            staticF = j.decode(Config.HatsF),
