    ...
    setmetatable(
    {
        -- veh
        {
            ...
            Vehicles = {
                ...
                ["Police"] = {
                    {name = "lspd1", price = 25000},
                    {name = "lspd4", price = 25000},
                    {name = "lspd5", price = 25000},
                    {name = "lspd6", price = 25000},
                    {name = "lspd7", price = 25000},
                    {name = "lspd8", price = 25000},
                    {name = "lspd11", price = 25000},
                    {name = "lspda", price = 25000},
                    {name = "lspdc", price = 25000},
                    {name = "lspde", price = 25000},
                    {name = "lspdf", price = 25000},
                    {name = "lspdg", price = 25000},
                    {name = "lspdh", price = 25000},
                    {name = "lspdi", price = 25000},
                    {name = "lspdj", price = 25000},
                    {name = "lspdk", price = 25000},
                    {name = "lspdl", price = 25000},
                    {name = "policeb", price = 25000},
                    {name = "policem1", price = 5000},
                    {name = "riot", price = 25000}
                },
                ["Vans"] = {
