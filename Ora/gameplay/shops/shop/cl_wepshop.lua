...
weapon_accessories = {
    [GetHashKey("WEAPON_PISTOL")] = {
        psuppressor = "COMPONENT_AT_PI_SUPP",
        plight = "COMPONENT_AT_PI_FLSH",
        pextendedclip = "COMPONENT_COMBATPISTOL_CLIP_02",
    },
    ...
    [GetHashKey("WEAPON_APPISTOL")] = {
        psuppressor = "COMPONENT_AT_PI_SUPP",
        plight = "COMPONENT_AT_PI_FLSH",
        pextendedclip = "COMPONENT_APPISTOL_CLIP_02",
    },
    ...
    [GetHashKey("WEAPON_SNSPISTOL")] = {
        pextendedclip = "COMPONENT_SNSPISTOL_CLIP_02",
    },
    ...
    [GetHashKey("WEAPON_HEAVYPISTOL_MK2")] = {
        pcompensator = "COMPONENT_AT_PI_COMP_03",
        plight = "COMPONENT_AT_PI_FLSH",
        pholo = "COMPONENT_AT_SIGHTS",
        pscopes = "COMPONENT_AT_SCOPE_MACRO_MK2",
        pextendedclip = "COMPONENT_APPISTOL_CLIP_02",
    },
    [GetHashKey("WEAPON_SNSPISTOL_MK2")] = {
        pextendedclip = "COMPONENT_SNSPISTOL_CLIP_02",
        plight = "COMPONENT_AT_PI_FLSH_03",
        pscopes = "COMPONENT_AT_PI_RAIL_02",
        psuppressor = "COMPONENT_AT_PI_SUPP_02",
    },
    [GetHashKey("WEAPON_PISTOL")] = {
        psuppressor = "COMPONENT_AT_PI_SUPP_02",
        plight = "COMPONENT_AT_PI_FLSH_02",
        pextendedclip = "COMPONENT_PISTOL_MK2_CLIP_02",
        pscope = "COMPONENT_AT_PI_RAIL",
    },
    [GetHashKey("WEAPON_VINTAGEPISTOL")] = {
        psuppressor = "COMPONENT_AT_PI_SUPP_02",
        pextendedclip = "COMPONENT_VINTAGEPISTOL_CLIP_02",
    },
    ...
    [GetHashKey("WEAPON_MICROSMG")] = {
        smgsuppressor = "COMPONENT_AT_AR_PI_SUPP",
        smglight = "COMPONENT_AT_PI_FLSH",
        smgextendedclip = "COMPONENT_MICROSMG_CLIP_02",
    },
    [GetHashKey("WEAPON_MINISMG")] = {
        smgextendedclip = "COMPONENT_MINISMG_CLIP_02",
    },
    [GetHashKey("WEAPON_SMG")] = {
        smgsuppressor = "COMPONENT_AT_PI_SUPP_02",
        smglight = "COMPONENT_AT_AR_FLSH",
        smgextendedclip = "COMPONENT_SMG_CLIP_02",

    },
    [GetHashKey("WEAPON_ASSAULTSMG")] = {
        smgsuppressor = "COMPONENT_AT_AR_SUPP_02",
        smglight = "COMPONENT_AT_AR_FLSH",
        smgextendedclip = "COMPONENT_ASSAULTSMG_CLIP_02",
    },
    [GetHashKey("WEAPON_COMBATPDW")] = {
        smgsuppressor = "COMPONENT_AT_AR_SUPP_02",
        smglight = "COMPONENT_AT_AR_FLSH",
        smgextendedclip = "COMPONENT_COMBATPDW_CLIP_02",
        smggrip = "COMPONENT_AT_AR_AFGRIP",
        smgscope = "COMPONENT_AT_SCOPE_SMALL",
    },
    -- Machines guns
    [GetHashKey("WEAPON_MG")] = {
        mgextendedclip = "COMPONENT_MG_CLIP_02",
        mgscope = "COMPONENT_AT_SCOPE_SMALL_02",
    },
    [GetHashKey("WEAPON_COMBATMG")] = {
        mgextendedclip = "COMPONENT_MG_CLIP_02",
        mgscope = "COMPONENT_AT_SCOPE_SMALL_02",
        mggrip = "COMPONENT_AT_AR_AFGRIP",
    },
    [GetHashKey("WEAPON_COMBATMG_MK2")] = {
        mgextendedclip = "COMPONENT_MG_CLIP_02",
        mgholo = "COMPONENT_AT_SIGHTS",
        mgscopem = "COMPONENT_AT_SCOPE_MEDIUM_MK2",
        mgscopes = "COMPONENT_AT_SCOPE_SMALL_MK2",
        mggrip = "COMPONENT_AT_AR_AFGRIP_02",
    },
    [GetHashKey("WEAPON_GUSENBERG")] = {
        mgextendedclip = "COMPONENT_GUSENBERG_CLIP_02",
    },
    [GetHashKey("WEAPON_MACHINEPISTOL")] = {
        mgsuppressor = "COMPONENT_AT_PI_SUPP",
        mgextendedclip = "COMPONENT_MACHINEPISTOL_CLIP_02",
    },

    -- Rifles
    [GetHashKey("WEAPON_ASSAULTRIFLE")] = {
        rlight = "COMPONENT_AT_AR_FLSH",
        rextendedclip = "COMPONENT_ASSAULTRIFLE_CLIP_02",
        rgrip = "COMPONENT_AT_AR_AFGRIP",
        rscope = "COMPONENT_AT_SCOPE_MACRO",
        rsuppressor = "COMPONENT_AT_AR_SUPP_02"

    },
    [GetHashKey("WEAPON_CARBINERIFLE")] = {
        rlight = "COMPONENT_AT_AR_FLSH",
        rextendedclip = "COMPONENT_CARBINERIFLE_CLIP_02",
        rscope = "COMPONENT_AT_SCOPE_MEDIUM",
        rsuppressor = "COMPONENT_AT_AR_SUPP",
        rgrip = "COMPONENT_AT_AR_AFGRIP",
    },
    [GetHashKey("WEAPON_ADVANCEDRIFLE")] = {
        rlight = "COMPONENT_AT_AR_FLSH",
        rextendedclip = "COMPONENT_ADVANCEDRIFLE_CLIP_02",
        rscope = "COMPONENT_AT_SCOPE_SMALL",
        rsuppressor = "COMPONENT_AT_AR_SUPP"
    },
    [GetHashKey("WEAPON_SPECIALCARBINE")] = {
        rlight = "COMPONENT_AT_AR_FLSH",
        rextendedclip = "COMPONENT_SPECIALCARBINE_CLIP_02",
        rgrip = "COMPONENT_AT_AR_AFGRIP",
        rscope = "COMPONENT_AT_SCOPE_MEDIUM",
        rsuppressor = "COMPONENT_AT_AR_SUPP_02",
    },
    [GetHashKey("WEAPON_BULLPUPRIFLE")] = {
        rextendedclip = "COMPONENT_BULLPUPRIFLE_CLIP_02",
        rgrip         = "COMPONENT_AT_AR_AFGRIP",
        rscope        = "COMPONENT_AT_SCOPE_SMALL",
        rsuppressor   = "COMPONENT_AT_AR_SUPP",
    },
    [GetHashKey("WEAPON_BULLPUPRIFLEMK2")] = {
        rextendedclip = "COMPONENT_BULLPUPRIFLE_MK2_CLIP_02",
        rgrip         = "COMPONENT_AT_AR_AFGRIP_02",
        rsuppressor   = "COMPONENT_AT_AR_SUPP_02",
        rlight = "COMPONENT_AT_AR_FLSH",

        rholo        = "COMPONENT_AT_SIGHTS",
        rscopes     = "COMPONENT_AT_SCOPE_MACRO_02_MK2",
        rscopem     = "COMPONENT_AT_SCOPE_SMALL_MK2",

    },
    [GetHashKey("WEAPON_SPECIALCARBINE_MK2")] = {
        rlight = "COMPONENT_AT_AR_FLSH",
        rextendedclip = "COMPONENT_SPECIALCARBINE_MK2_CLIP_02",
        rgrip = "COMPONENT_AT_AR_AFGRIP_02",
        rsuppressor = "COMPONENT_AT_AR_SUPP_02",
        rholo = "COMPONENT_AT_SIGHTS",
        rscopes = "COMPONENT_AT_SCOPE_MACRO_MK2",
        rscopel = "COMPONENT_AT_SCOPE_MEDIUM_MK2",
    },
    [GetHashKey("WEAPON_ASSAULTRIFLE_MK2")] = {
        rlight = "COMPONENT_AT_AR_FLSH",
        rextendedclip = "COMPONENT_ASSAULTRIFLE_MK2_CLIP_02",
        rgrip = "COMPONENT_AT_AR_AFGRIP_02",
        rsuppressor = "COMPONENT_AT_AR_SUPP_02",
        rholo = "COMPONENT_AT_SIGHTS",
        rscopes = "COMPONENT_AT_SCOPE_MACRO_MK2",
    ...
    [GetHashKey("WEAPON_CARBINERIFLE_MK2")] = {
        rlight = "COMPONENT_AT_AR_FLSH",
        rextendedclip = "COMPONENT_CARBINERIFLE_MK2_CLIP_02",
        rgrip = "COMPONENT_AT_AR_AFGRIP_02",
        rsuppressor = "COMPONENT_AT_AR_SUPP",
        rholo = "COMPONENT_AT_SIGHTS",
        rscopes = "COMPONENT_AT_SCOPE_MACRO_MK2",
    ...
    [GetHashKey("WEAPON_COMPACTRIFLE")] = {
        rextendedclip = "COMPONENT_COMPACTRIFLE_CLIP_02",
    },
    [GetHashKey("WEAPON_MILITARYRIFLE")] = {
        rlight = "COMPONENT_AT_AR_FLSH",
        rextendedclip = "COMPONENT_MILITARYRIFLE_CLIP_02",
        rscope = "COMPONENT_AT_SCOPE_SMALL",
        rsuppressor = "COMPONENT_AT_AR_SUPP",
    },
    -- Sniper rifles
    [GetHashKey("WEAPON_HEAVYSNIPER")] = {
        sscopem = "COMPONENT_AT_SCOPE_LARGE",
        sscopel = "COMPONENT_AT_SCOPE_MAX",
    },
    [GetHashKey("WEAPON_SNIPERRIFLE")] = {
        sscopem = "COMPONENT_AT_SCOPE_LARGE",
        sscopel = "COMPONENT_AT_SCOPE_MAX",
        ssuppressor = "COMPONENT_AT_AR_SUPP_02",
    },
    -- Shotguns
    [GetHashKey("WEAPON_PUMPSHOTGUN")] = {
        sglight = "COMPONENT_AT_AR_FLSH",
        sgsuppressor = "COMPONENT_AT_SR_SUPP",
    },
    [GetHashKey("WEAPON_ASSAULTSHOTGUN")] = {
        sextendedclip = "COMPONENT_ASSAULTSHOTGUN_CLIP_02",
        sglight = "COMPONENT_AT_AR_FLSH",
        sgsuppressor = "COMPONENT_AT_AR_SUPP",
    },
    [GetHashKey("WEAPON_BULLPUPSHOTGUN")] = {
        sglight = "COMPONENT_AT_AR_FLSH",
        sgsuppressor = "COMPONENT_AT_AR_SUPP_02",
    },
    [GetHashKey("WEAPON_PUMPSHOTGUN_MK2")] = {
        sglight = "COMPONENT_AT_AR_FLSH",
        sgsuppressor = "COMPONENT_AT_SR_SUPP_03",
        sgscope = "COMPONENT_AT_SCOPE_MACRO_MK2",
        sgscopem = "COMPONENT_AT_SCOPE_SMALL_MK2",
    },
    [GetHashKey("WEAPON_HEAVYSHOTGUN")] = {
        sglight = "COMPONENT_AT_AR_FLSH",
        sgsuppressor = "COMPONENT_AT_AR_SUPP_02",
        sggrip = "COMPONENT_AT_AR_AFGRIP",
    },
}
