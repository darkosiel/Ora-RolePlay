...
IllegalLabsAndWarehouse.AVAILABLE_GUNLEADS = {
  ...
  gunlead1 = {
    ...
    limitations = {
      ...
      {name = "snspistol", byWeek = 10, price = 10000},
      {name = "pistol", byWeek = 15, price = 14000},
      {name = "pitollourd", byWeek = 3, price = 20000},
    ...
    production = {
      ...
      [4] = {
        ...
        description = "Pour 85 000$ vous obtenez 5 Berettas, 3 pistolets lourds, 2 Skorpions, 1 Tec9, 60 Calibre 12, 750 balles de 9mm et 10 explosifs artisanaux en plus par semaine par rapport à la limite de base",
        price = 85000,
        addon = {
          pistol = 18,
          pitollourd = 10,
      ...
      [6] = {
          ...
          description = "Pour 85 000$ vous obtenez 10 Berettas, 10 Pistolet Céramique, 8 Calibre 50, 5 pistolets lourds, 2 Skorpions, 2500 balles de 9mm, 2 Tec9, 1 Gusenberg, 2 Uzis 60 Calibre 12 et 20 explosifs artisanaux en plus par semaine par rapport à la limite de base",
          price = 85000,
          addon = {
            pistol = 33,
            -- ceramicpistol = 15,
