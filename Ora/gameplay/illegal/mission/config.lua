...
missionConfig.boss = {
    {
        name = "Pablo",
        pos = {x = -29.45, y = -643.93, z = 35.86 - 0.98, a = 165.72}, --{x=3091.76,y=-4712.5,z=15.26,a=202.32}, --{x=473.52,y=-1310.39,z=28.23,a=202.32},
    ...
    {
        name = "Josh",
        pos = {x = 356.40, y = 3399.41, z = 36.40 - 0.98, a = 201.88}, --{x=3091.76,y=-4712.5,z=15.26,a=202.32}, --{x=473.52,y=-1310.39,z=28.23,a=202.32},
    ...
    {
        name = "Manny",
        pos = {x = 1080.51 , y = -2412.93, z = 30.16 - 0.98, a = 264.84}, --{x=3091.76,y=-4712.5,z=15.26,a=202.32}, --{x=473.52,y=-1310.39,z=28.23,a=202.32},
        model = "csb_ortega",
        missions = {
            "Passeur d'immigrés"
        }
...
missionConfig.missionLists = {
    ["Récupération de véhicule Compacts"] = {
        levelRequired = 1,
        scenarioIndex = 1,
        policeRequired = Ora.Illegal:GetCopsRequired("carroberry"),
        policeType = {"police"},
    ...
    ["CarJacking - Voitures Muscle"] = {
        levelRequired = 1,
        scenarioIndex = 3,
        policeRequired = Ora.Illegal:GetCopsRequired("carjacking"),
        policeType = {"lssd", "police"},
    ...
    ["Passeur d'immigrés"] = {
        levelRequired = 1,
        scenarioIndex = 4,
        policeRequired = Ora.Illegal:GetCopsRequired("migrantsmuggling"),
        policeType = {"lssd", "police"},
