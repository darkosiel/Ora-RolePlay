...
lang = "FR" --Language selector, be sur that the language is created bellow
...
TenuFemme = {
	[3] = {model = 3, colorA = 0, colorB = 0}, -- Torso / Arms / Bras
	[4] = {model = 79, colorA = 3, colorB = 5}, -- Legs / Pants / Jambe
	[6] = {model = 58, colorA = 3, colorB = 5}, -- Feet / Shoes / Chaussure
	
	[7] = {model = 0, colorA = 0, colorB = 0}, --Accessories / Accessoires
	[8] = {model = 8, colorA = 0, colorB = 0}, --Undershirt / T-Shirt
	[11] = {model = 180, colorA = 3, colorB = 5} --Tops / Veste
	
	}
	
	local TenuHomme = {
	[3] = {model = 4, colorA = 0, colorB = 0}, -- Torso / Arms / Bras
	[4] = {model = 77, colorA = 3, colorB = 5}, -- Legs / Pants / Jambe
	[6] = {model = 55, colorA = 3, colorB = 5}, -- Feet / Shoes / Chaussure
	
	[7] = {model = 0, colorA = 0, colorB = 0}, --Accessories / Accessoires
	[8] = {model = 15, colorA = 0, colorB = 0}, --Undershirt / T-Shirt
	[11] = {model = 178, colorA = 3, colorB = 5}, --Tops / Veste
	}
